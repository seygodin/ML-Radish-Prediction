# verify_mamba_normal_vs_d4.md

- task: classification (normal_vs_d4), backbone: mamba
- status (reported): ok
...
|---|---|---|---|
| pr_auc (primary) | 0.6289 | 0.6289 | ok |
| macro_f1 | 0.5486 | 0.5486 | ok |
| recall_disease | 1.0000 | 1.0000 | ok |
| precision_disease | 0.1021 | 0.1021 | ok |
| accuracy | 0.8410 | 0.8410 | ok |

### 7-metric set (user-required): recomputed from predictions; loss = best-epoch per_epoch

| metric | reported | recomputed | match |
|---|---|---|---|
| recall (macro) | 0.9190 | 0.9190 | ok |
| precision (macro) | 0.5511 | 0.5511 | ok |
| f1-score (macro) | 0.5486 | 0.5486 | ok |
| AUROC | 0.9769 | 0.9769 | ok |
| train_loss (best ep) | 0.3533 | 0.3533 | ok |
| val_loss (best ep) | 0.2988 | 0.2988 | ok |
| accuracy | 0.8410 | 0.8410 | ok |

- AUROC convention: ROC-AUC on P(disease) (2-class). best epoch = 14.
...
[[1092, 211], [0, 24]]
```
reported confusion: [[1092, 211], [0, 24]]
